...
{
    int getCount(Ice.Current __current);
    ...
    song findByBoth(String title, String artist, Ice.Current __current);

    song[] findByAny(String searchKey, Ice.Current __current);
